...
class ControlEmployee extends StatefulWidget {
  ...
  @override
  State<ControlEmployee> createState() => _ControlEmployeeState();
}

class _ControlEmployeeState extends State<ControlEmployee> {
  ...
  Widget _buildUserList(CollectionReference users) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: users.where('role', whereIn: ['admin', 'empleado']).snapshots(),
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        var filteredDocs = snapshot.data!.docs.where((doc) {
          ...
          bool matchesCI = ciQuery.isEmpty ||
              data['CI'].toString().toLowerCase().contains(ciQuery);
  ...
  void _showEditUserDialog(String userId, Map<String, dynamic> userData) {
    ...
    selectedRole = userData['role'] ?? 'admin';
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(color: Colors.black)),
                    style: TextStyle(color: Colors.black),
                    items: <String>['admin', 'empleado'].map((String value) {
